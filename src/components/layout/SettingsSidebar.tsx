  ...
  return (
    <div className="flex h-screen w-64 flex-col bg-white dark:bg-zinc-950 border-r border-gray-200 dark:border-zinc-800 shadow-sm fixed z-40 overflow-y-auto">
      ...
      <div className="p-4 border-t border-gray-200 dark:border-zinc-800">
        <Link
          href="/dashboard"
          className="flex w-full items-center gap-3 px-3 py-2.5 rounded-lg font-medium text-gray-600 hover:text-gray-900 hover:bg-gray-50 dark:text-gray-400 dark:hover:text-white dark:hover:bg-zinc-900/50 transition-all duration-200 text-sm"
        >
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
