    ...
    <div className="flex h-screen w-64 flex-col bg-white dark:bg-zinc-950 border-r border-gray-200 dark:border-zinc-800 shadow-sm fixed z-40 overflow-y-auto">
      ...
      <div className="px-4 py-2 border-t border-gray-200 dark:border-zinc-800">
        <Link
          ...
          className={`flex w-full items-center gap-3 px-3 py-2 rounded-lg font-medium transition-all duration-200 text-sm ${
