      ...
      {showAccountForm && (
        <div className="flex justify-center transition-all">
          <form onSubmit={handleCreateAccount} className="w-full max-w-md bg-white dark:bg-zinc-900 p-6 rounded-xl border shadow-md space-y-4">
            <h4 className="font-bold text-gray-855 dark:text-white">{labels[lang].addAcc}</h4>
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2 border rounded-lg dark:bg-zinc-855 dark:border-zinc-700 dark:text-white"
                >
